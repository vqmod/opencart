...
abstract class VQMod {
    ...
    // @GeekoDev - Get files from opencart 4.x extension folders
    if (defined('DIR_EXTENSION')) {
      $opencartExtFileList = glob(DIR_EXTENSION . '*/vqmod/*.xml');
      self::$_modFileList = array_merge(self::$_modFileList, $opencartExtFileList);
    }
    // END - Get files from opencart 4.x extension folders
